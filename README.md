...
Broadlink Universal IR Remote Controller plugin for Domoticz. **Note:** The plugin is under development. The plugin was tested with python 3.5.x and Domoticz 4.x installed on Raspberry Pi. Plugin supports Broadlink RM2 Pro/Plus, Broadlink RM mini3
